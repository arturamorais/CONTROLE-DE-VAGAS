        ...
        <div style="margin-top:0.625rem;padding-left:0.5rem;border-left:2px solid var(--gray-light);display:flex;flex-direction:column;gap:0.625rem">
          ${historico.map(h => {
            ...
            <div style="display:flex;gap:0.625rem;align-items:flex-start">
              ...
              <div style="flex:1;min-width:0">
                ${(() => { const d = escapeHtmlDash(h.descricao||''); const long = (h.descricao||'').length>120||(h.descricao||'').includes('\n'); return long ? `<span class="historico-desc h-collapsed" style="font-size:0.8rem;font-weight:600;color:var(--navy-mid);line-height:1.45">${d}</span><button class="ver-mais-btn" onclick="toggleVerMais(this)">ver mais ▾</button>` : `<div style="font-size:0.8rem;font-weight:600;color:var(--navy-mid);line-height:1.45;white-space:pre-line">${d}</div>`; })()}
